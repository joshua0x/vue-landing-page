     ...
     <!--        <div>
            ...
            <nav class="flex justify-end flex-col md:flex-row">
                ...
                <ul class="space-x-10 font-theme-heading font-medium items-center hidden md:flex  flex-col space-y-7 md:space-y-0 md:flex-row">
                    ...
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#legal" v-smooth-scroll>Legal</a></li>
                    ...
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#pricing" v-smooth-scroll>Pricing</a></li>
