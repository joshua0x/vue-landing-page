<template>
  <div id="pricing" class="flex flex-col w-full items-center fancyOverlay">
        ...
        >
          ...
          >
            ...
            <p class="mt-6 flex items-baseline gap-x-1">
              ...
              <span :class="[tier.featured ? 'text-white dark:text-black' : 'text-black dark:text-white']">
...
const pricingFrequencies = [
  { id: '1', value: '1', label: 'Free', priceSuffix: '' },
];
...
const pricingTiers = [
  ...
  },
  {
    ...
    features: [
      ...
      `you can use new features added later.`,
    ],
    featured: false,
    highlighted: true,
    soldOut: false,
